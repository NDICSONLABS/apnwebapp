    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_type', models.CharField(choices=[('contact_form', 'Contact Form'), ('donation_form', 'Donation Form'), ('volunteer_form', 'Volunteer Form')], default='contact_form', max_length=255)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='partnership.partnershippage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
