...
from news.block import ContentBlock
...
class NewsletterIndex(RoutablePageMixin, Page):
    ...
    subscribe_text = RichTextField(
        default='Please enter your name and email-address to subscribe to our newsletter')  # noqa
    subscribe_success_heading = models.CharField(max_length=100, default='Thank you')  # noqa
    subscribe_success_text = RichTextField(
        default='Thank you for subscribing. Please validate your email. A verification email has been sent to your email address.')  # noqa
    subscribe_fail_heading = models.CharField(max_length=100, default="We're sorry")  # noqa
    subscribe_fail_text = RichTextField(
        default='The email you entered may be already registered. Please Contact us to resolve the issue.')  # noqa
    unsubscribe_heading = models.CharField(max_length=100, default='Unsubscribe to our newsletter')  # noqa
    unsubscribe_text = RichTextField(
        default='Please enter your name and email-address to subscribe to our newsletter.')  # noqa
    ...
    unsubscribe_success_text = RichTextField(
        default="You have successfully unsubscribed from our mailing list.\n We hope to see you again in the future")  # noqa
    validate_success_heading = models.CharField(max_length=100, default='Thank you.')  # noqa
    validate_success_text = RichTextField(
        default='our email has been validated. You are now officially subscribed to our newsletter.')  # noqa
    validate_fail_heading = models.CharField(max_length=100, default='Sorry, something went wrong.')  # noqa
    validate_fail_text = RichTextField(
        default='Your email could not be validated. Please contact us to solve this problem.')  # noqa
